...
// Your live backend (from Cloud Run)
const BACKEND_URL = "https://nexus-os-backend-445137667521.europe-west1.run.app";

// Supabase (frontend uses the ANON key — safe to expose, RLS protects data)
...
// Helper: API calls to your backend
...
function toast(message, type = "info", duration = 3000) {
  ...
  el.className = `fixed bottom-20 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-lg font-mono text-sm border ${type}`;
